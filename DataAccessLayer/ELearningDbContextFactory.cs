...
public class DesignTimeDbContextFactory : IDesignTimeDbContextFactory<ELearningDbContext>
{
    public ELearningDbContext CreateDbContext(string[] args)
    {
        ...
        optionsBuilder.UseSqlServer("SERVER=DESKTOP-NDH7B6T;DATABASE=ELearningDB4;Trusted_Connection=True;TrustServerCertificate=True;MultipleActiveResultSets=true");
